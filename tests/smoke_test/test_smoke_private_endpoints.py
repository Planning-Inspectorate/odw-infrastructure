...
from odw_common.private_endpoint.synapse_private_endpoint_manager import SynapsePrivateEndpointManager
from tests.util.private_endpoint.synapse_private_link_hubs_private_endpoint_manager import SynapsePrivateLinkHubsPrivateEndpointManager
...
from tests.util.private_endpoint.synapse_managed_private_endpoint_manager import SynapseManagedPrivateEndpointManager
