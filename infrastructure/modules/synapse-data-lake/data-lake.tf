...
output "secondary_blob_endpoint" {
  value = azurerm_storage_account.synapse.secondary_blob_endpoint
}

output "secondary_dfs_endpoint" {
  value = azurerm_storage_account.synapse.secondary_dfs_endpoint
}

output "secondary_queue_endpoint" {
  value = azurerm_storage_account.synapse.secondary_queue_endpoint
}

output "secondary_table_endpoint" {
  value = azurerm_storage_account.primary.secondary_table_endpoint
}
