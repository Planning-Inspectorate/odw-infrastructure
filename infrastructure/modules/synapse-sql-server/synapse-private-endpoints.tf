...
resource "azurerm_synapse_managed_private_endpoint" "cbos_sql_dev" {
  name                 = "synapse-cbos-sqlServer-dev"
  synapse_workspace_id = var.synapse_workspace_id
  target_resource_id   = "/subscriptions/962e477c-0f3b-4372-97fc-a198a58e259e/resourceGroups/pins-rg-local-plans-dev/providers/Microsoft.Sql/servers/pins-sql-local-plans-primary-dev"
  subresource_name     = "sqlServer"
}